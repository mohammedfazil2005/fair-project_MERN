      ...
      <Collapse in={open}>
        <div id="example-collapse-text">
          <div className="d-flex flex-column align-items-center shadow p-2">
            ...
            <input value={data.gitlink} onChange={(e)=>setData({...data,gitlink:e.target.value})} type="text" placeholder='User GITHUB Link' className='form-control mt-2' />
            <input value={data?.linkedinlink} type="text" placeholder='User LINKEDIN Link' className='form-control mt-2' onChange={(e) => setData({ ...data, linkedinlink: e.target.value })} />
